        ...
        >
          <div className='py-4'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
              {/* 邮箱绑定 */}
              <Card className='ps-inner-card !rounded-xl'>
              ...
              {status.custom_oauth_providers &&
                status.custom_oauth_providers.map((provider) => {
                  ...
                  return (
                    <Card key={provider.slug} className='ps-inner-card !rounded-xl'>
                      <div className='flex items-center justify-between gap-3'>
                        <div className='flex items-center flex-1 min-w-0'>
                          <div className='w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center mr-3 flex-shrink-0'>
                            {getOAuthProviderIcon(
          ...
          <div className='py-4'>
            <div className='space-y-6'>
              <Space vertical className='w-full'>
                {/* 系统访问令牌 */}
                <Card className='ps-inner-card !rounded-xl w-full'>
