...
import SettingsContact from '../../pages/Setting/Dashboard/SettingsContact';
import SettingsHomePage from '../../pages/Setting/Dashboard/SettingsHomePage';
  ...
  return (
    <>
      <Spin spinning={loading} size='large'>
        ...
        {/* 首页版块配置 */}
        <Card style={{ marginTop: '10px' }}>
          <SettingsHomePage options={inputs} refresh={onRefresh} />
        </Card>

        {/* 联系方式管理 */}
        <Card style={{ marginTop: '10px' }}>
          <SettingsContact options={inputs} refresh={onRefresh} />
        </Card>
