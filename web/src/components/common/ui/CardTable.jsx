...
/* ─── MobileRowCard — defined OUTSIDE CardTable so React preserves its identity
   across parent re-renders (avoids full unmount/remount of every card) ──────── */
const MobileRowCard = ({ record, index, columns, tableProps, rowKeyVal, t }) => {
    ...
    <div className='flex flex-col gap-2'>
      {dataSource.map((record, index) => (
        <MobileRowCard
          ...
          rowKeyVal={getRowKey(record, index)}
          t={t}
        />
      ))}
