...
const Dashboard = () => {
  ...
  const contactImage = statusState?.status?.contact_image || '';
  const contactTitle = statusState?.status?.contact_title || '';
  const contactCaption = statusState?.status?.contact_caption || '';
  const contactImage2 = statusState?.status?.contact_image2 || '';
  const contactTitle2 = statusState?.status?.contact2_title || '';
  const contactCaption2 = statusState?.status?.contact2_caption || '';
      ...
      {dashboardData.hasInfoPanels && (
        <div className='mb-4'>
          <div className='grid grid-cols-1 lg:grid-cols-4 gap-4'>
            ...
            {/* 联系方式卡片 1 */}
            {dashboardData.contactEnabled && contactImage && (
              <ContactPanel
            ...
            {/* 联系方式卡片 2 */}
            {dashboardData.contact2Enabled && contactImage2 && (
              <ContactPanel
                contactImage={contactImage2}
                contactTitle={contactTitle2}
                contactCaption={contactCaption2}
                CARD_PROPS={CARD_PROPS}
                t={dashboardData.t}
              />
            )}
