...
export default function GeneralSettings(props) {
  ...
  const [inputs, setInputs] = useState({
    ...
    'general_setting.token_group_help_link': '',
    'general_setting.token_group_help_text': '',
        ...
        >
          <Form.Section text={t('通用设置')}>
            <Row gutter={16}>
              ...
              <Col xs={24} sm={12} md={8} lg={8} xl={8}>
                <Form.Input
                  field={'general_setting.token_group_help_link'}
                  label={t('令牌分组帮助链接')}
                  initValue={''}
                  placeholder={t('例如 https://example.com/help')}
                  onChange={handleFieldChange('general_setting.token_group_help_link')}
                  showClear
                />
              </Col>
              <Col xs={24} sm={12} md={8} lg={8} xl={8}>
                <Form.Input
                  field={'general_setting.token_group_help_text'}
                  label={t('令牌分组帮助文字')}
                  initValue={''}
                  placeholder={t('例如：如何选择分组?')}
                  onChange={handleFieldChange('general_setting.token_group_help_text')}
                  showClear
                />
              </Col>
