...
func InitOptionMap() {
	...
	common.OptionMap["AllowedCallbackDomains"] = ""
	...
	common.OptionMap["QQOAuthBaseUrl"] = common.QQOAuthBaseURL
	...
	common.OptionMap["InvitationRewardRule"] = operation_setting.InvitationRewardRule
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "AllowedCallbackDomains":
		operation_setting.AllowedCallbackDomains = value
	case "EpayId":
	...
	case "InvitationFirstTopupThreshold":
		operation_setting.InvitationFirstTopupThreshold, _ = strconv.ParseFloat(value, 64)
	case "InvitationFirstTopupReward":
		operation_setting.InvitationFirstTopupReward, _ = strconv.ParseFloat(value, 64)
	case "InvitationRewardRule":
		operation_setting.InvitationRewardRule = value
